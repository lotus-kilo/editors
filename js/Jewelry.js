...
function saveItem() {
    ...
    // 保存到本地存储
    let jewelries = JSON.parse(localStorage.getItem('jewelries') || '[]');
    jewelries.push(jewelryData);
    localStorage.setItem('jewelries', JSON.stringify(jewelries));
